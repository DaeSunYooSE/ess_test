...
export const getColor = (name: any, dom = document.documentElement) => {
...
// E-Commerce
//===============================
export const calculateSale = (base: number, less = 0, fix = 2) =>
...
export const getTotalPrice = (cart: any[], baseItems: any[]) =>
  cart.reduce(
    (accumulator: number, currentValue: { id: any; quantity: any }) => {
      ...
      const { price, sale } = baseItems.find(
...
export const flatRoutes = (
  childrens: (
    ...
    | {
        ...
        active: boolean
        icon: string
        children: { name: string; to: string; active: boolean }[]
        to?: undefined
      }
  )[]
) => {
